...
def build_seal(run_root: Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": "lossy-source-digest-utility-run-seal-v0",
...
def verify_seal(run_root: Path) -> dict[str, Any]:
    ...
    return {"schema_version": "lossy-source-digest-utility-run-seal-verification-v0", "run_id": run_root.name, "passed": not failures, "failures": failures, "file_manifest_sha256": observed["file_manifest_sha256"]}
